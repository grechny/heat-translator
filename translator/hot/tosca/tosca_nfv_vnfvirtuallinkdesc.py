...
TARGET_CLASS_NAME = 'ToscaNfvVnfVirtualLinkDesc'


class ToscaNfvVnfVirtualLinkDesc(HotResource):
    '''Translate TOSCA node type tosca.nodes.nfv.VnfVirtualLinkDesc.'''

    toscatype = 'tosca.nodes.nfv.VnfVirtualLinkDesc'
    SUBNET_SUFFIX = '_subnet'
    NETWORK_PROPS = ['network_name', 'network_id', 'segmentation_id']
    SUBNET_PROPS = ['ip_version', 'cidr', 'start_ip', 'end_ip', 'gateway_ip', 'dhcp_enabled']
